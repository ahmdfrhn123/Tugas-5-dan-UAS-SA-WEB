                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="" method="post">
                            ...
                            <div class="form-group">
                                <label for="remember" class="text-info"><span>Remember me</span> <span><input id="remember_me" name="remember_me" type="checkbox"></span></label>
                                <br>
                                <button type="submit" class="btn btn-primary">Login</button>
                            </div>
                            <div id="register-link" class="text-center">
                                <p>Forgot your password ? <a href="forgot.php" class="text-right" style="text-align: right">Forgot here</a></p>
                                <p>Dont have account ? <a href="register.php" class="text-right">Register here</a></p>
                            </div>
                        </form>
                    </div>
                </div>
